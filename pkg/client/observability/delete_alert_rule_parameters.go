...
// WithID adds the id to the delete alert rule params
func (o *DeleteAlertRuleParams) WithID(id int64) *DeleteAlertRuleParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the delete alert rule params
func (o *DeleteAlertRuleParams) SetID(id int64) {
	o.ID = id
}
