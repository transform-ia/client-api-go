...
// WithAlertManagerURL adds the alertManagerURL to the delete silence params
func (o *DeleteSilenceParams) WithAlertManagerURL(alertManagerURL string) *DeleteSilenceParams {
	o.SetAlertManagerURL(alertManagerURL)
	return o
}

// SetAlertManagerURL adds the alertManagerUrl to the delete silence params
func (o *DeleteSilenceParams) SetAlertManagerURL(alertManagerURL string) {
	o.AlertManagerURL = alertManagerURL
}

// WithID adds the id to the delete silence params
func (o *DeleteSilenceParams) WithID(id string) *DeleteSilenceParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the delete silence params
func (o *DeleteSilenceParams) SetID(id string) {
	o.ID = id
}
...
func (o *DeleteSilenceParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// query param alertManagerURL
	qrAlertManagerURL := o.AlertManagerURL
	qAlertManagerURL := qrAlertManagerURL
	if qAlertManagerURL != "" {

		if err := r.SetQueryParam("alertManagerURL", qAlertManagerURL); err != nil {
			return err
		}
	}
