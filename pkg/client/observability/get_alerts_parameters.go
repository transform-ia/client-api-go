...
// WithStatus adds the status to the get alerts params
func (o *GetAlertsParams) WithStatus(status string) *GetAlertsParams {
	o.SetStatus(status)
	return o
}

// SetStatus adds the status to the get alerts params
func (o *GetAlertsParams) SetStatus(status string) {
	o.Status = status
}
