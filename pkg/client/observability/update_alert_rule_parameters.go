...
type UpdateAlertRuleParams struct {
	...
	/* Body.
	   ...
	   Alert rule details
	*/
	Body *models.ObservabilityAlertRuleUpdatePayload
...
func (o *UpdateAlertRuleParams) WithBody(body *models.ObservabilityAlertRuleUpdatePayload) *UpdateAlertRuleParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update alert rule params
func (o *UpdateAlertRuleParams) SetBody(body *models.ObservabilityAlertRuleUpdatePayload) {
	o.Body = body
}

// WithID adds the id to the update alert rule params
func (o *UpdateAlertRuleParams) WithID(id int64) *UpdateAlertRuleParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the update alert rule params
func (o *UpdateAlertRuleParams) SetID(id int64) {
	o.ID = id
}
