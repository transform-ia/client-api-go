...
func (a *Client) RoleList(params *RoleListParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*RoleListOK, error) {
	...
	op := &runtime.ClientOperation{
		...
		Params:             params,
		Reader:             &RoleListReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	msg := fmt.Sprintf("unexpected success response for RoleList: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
